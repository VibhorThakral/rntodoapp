# React-Native Todo List App
 ...
 ## iosOutputs
------
 ### Login & Note View Functionality
 <img width="300px" src="./src/assets/loginfunc.gif"/>

 ### SigUp Functionality
 <img width="300px" src="./src/assets/signupfunc.gif"/>

 ### Session Management
 <img width="300px" src="./src/assets/sessionfunc.gif"/>

 ### Dark Theme
 <img width="300px" src="./src/assets/darkmodefunc.gif"/>


 ### androidView
 -----
 <img width="300px" src="./src/assets/androidview.gif" /> 